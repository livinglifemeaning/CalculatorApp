...
if(preferredTheme){
    doc.setAttribute("color-scheme", preferredTheme)
...
const deleteValueFromCalculation = () => {
    if(display.textContent.length === 1){display.textContent = "0"}else{display.textContent = display.textContent.slice(0, -1)}
